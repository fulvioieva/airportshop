...
public class OrderDetail {
	...
	public OrderDetail(int idOrder, String idArticle, int qtaOrdered, int unitPrice, int totalPrice) {
		super();
	...
	public String toString() {
		return "OrderHead [idOrder=" + idOrder + ", idArticle=" + idArticle + ", qtaOrdered=" + qtaOrdered
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(idArticle, other.idArticle) && idOrder == other.idOrder && qtaOrdered == other.qtaOrdered
